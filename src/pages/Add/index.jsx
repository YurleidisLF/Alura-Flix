...
const Add = () => {
  ...
  return (
    <AddContainer>
      <MainTitleContainer>
        <h1>Nuevo Video</h1>
        <p>Complete el siguiente formulario para crear una nueva card :)</p>
      </MainTitleContainer>

      <FormStyles onSubmit={handleSubmit}>
        <TitleStyles>crear card</TitleStyles>
        ...
        <FormInput
          ...
          pattern="^https:\/\/i\.ytimg\.com\/vi\/.*$"
					title="Por favor ingresa una Url de youtube"
        >
          Imagen
        </FormInput>
        <FormInput
        ...
        <FormInput
          ...
          big
          placeholder="¿Qúe explica el vídeo o que trata este vídeo?"
          name="descripcion"
          minlength="3"
          maxlength="6000"
        >
