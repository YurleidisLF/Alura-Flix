...
const GlobalContextProvider = ({ children }) => {
  ...
  useEffect(() => {
    fetch(
      "https://my-json-server.typicode.com/YurleidisLF/alura-flix-api/categorias"
    )
      .then((res) => res.json())
  ...
  useEffect(() => {
    fetch(
      "https://my-json-server.typicode.com/YurleidisLF/alura-flix-api/videos"
    )
      .then((res) => res.json())
  ...
  const deleteVideo = (id) => {
    fetch(
      `https://my-json-server.typicode.com/YurleidisLF/alura-flix-api/videos/${id}`,
      { method: "DELETE" }
    )
      .then((res) => {
        if (!res.ok) {
